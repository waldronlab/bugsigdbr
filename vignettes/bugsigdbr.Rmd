...
subsetting the `Condition` column to all descendants of that term in the EFO
ontology and that are present in the `Condition` column. Here, we demonstrate
...
`Body site` column to all  descendants of that term in the UBERON ontology and
that are present in the `Body site` column. For example, we can use `subsetByOntology`
