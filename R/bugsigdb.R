...
#'
#' Stable release: \url{https://doi.org/10.5281/zenodo.19740674}
#'
...
#'
#' Release v1.3.1: \url{https://doi.org/10.5281/zenodo.19740674}
#'
...
#'
#' @export
importBugSigDB <- function(version = "10.5281/zenodo.19740674", cache = TRUE)
{
